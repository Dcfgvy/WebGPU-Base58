...
\r
// Supports input up to 2968 MB in size (floor((2^32 - 1) / 1.38) bytes) in big-endian byte order.\r
...
/**\r
  IN BYTES !!!\r
  Max value = floor((2^32 - 1) / 1.38)\r
*/\r
@group(0) @binding(1) var<storage, read> input_size_arr: array<u32, 1>;\r
\r
/**\r
  Minimum size of ceil(input size * 1.38).\r
...
*/\r
@group(0) @binding(2) var<storage, read_write> b58_bytes: array<u32>; // TODO maybe bit-pack 5 elements per u32\r
\r
/**\r
  {\r
